...
public class BumpWallScript : MonoBehaviour
{	
	// Delegates and Events
	public delegate void Move();
	public static event Move Up;
	
	// Colliders
	public BoxCollider2D upArrowCollider;
    ...
    void Update()
    {
        if (gameObject.activeInHierarchy)
		{
			...
			{
				transform.Translate(0f, -0.05f * Time.timeScale, 0f);
