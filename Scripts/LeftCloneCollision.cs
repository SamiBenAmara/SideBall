...
public class LeftCloneCollision : MonoBehaviour
{
	// Delegate and Event
	public delegate void LeftCollide();
	public static event LeftCollide hitLeftWall;
	...
	// Collision Script for the cloned left wall
